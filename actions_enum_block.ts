...
namespace language {
    ...
    //% enumPromptHint="e.g. Forward, Left, Pinch, ..."
    //% enumInitialMembers="Forward, Backward, Left, Right, Pinch, Unpinch, Stop"
    ...
    //% blockId=show_action
    //% block="show $action"
    //% action.shadow="action_enum_shim"
    export function showAction(action: number) {
    }
}